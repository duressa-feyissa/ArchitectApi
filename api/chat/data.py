home = {
"initial": "Hello, how are you?, we are in the process of assisting a client to determine if they can build a home within their specified budget and time constraints. We have a set of questions and the client's answers. Based on their responses, budget limitations, time constraints, and the estimated costs of materials and labor, We will utilize cost estimations for materials and labor required to construct the home, considering the data provided in our previous discussions. Considering the budget user select residential. Make sure that the client's budget assigned for the home to be built and the estimated budget can be aligned Check the response for question number 3 budget capacity. If not, the design may not be feasible. These are the questions in order by one by one \"questions\": [{\"question\": \"1. Are there specific future-proofing considerations you'd like to address in the design to accommodate changing needs over time?\",\"options\": [\"A. Aging in place\", \"B. Accommodating a home office\", \"C. Energy Efficiency\", \"D. Sustainable Design\"]},{\"question\": \"2. Are there any cultural or religious considerations that should be integrated into the design?\",\"options\": [\"A. Prayer Room\", \"B. Cultural Symbolism\", \"C. Meditation Space\", \"D. Traditional Artifacts\"]},{\"question\": \"3. What is the budget range you are considering for your residential project?\",\"options\": [\"A. $10,000 - $50,000\", \"B. $50,000 - $100,000\", \"C. $100,000 - $250,000\", \"D. Over $250,000\"]},{\"question\": \"4. How many family members will be residing in the home?\",\"options\": [\"A. 0\", \"B. 1-3\", \"C. 4 - 7\", \"D. 8+\"]},{\"question\": \"5. Do you have any specific security or safety requirements for your home?\",\"options\": [\"A. Security System\", \"B. Childproofing\", \"C. Both\", \"D. None\"]},{\"question\": \"6. Do you require any outdoor spaces like a garden, patio, or playground for children?\",\"options\": [\"A. Garden\", \"B. Patio\", \"C. Playground\", \"D. None\"]},{\"question\": \"7. How many vehicles do you own, and do you need a garage or parking spaces for them?\",\"options\": [\"A. No\", \"B. 1\", \"C. 2\", \"D. 3\"]},{\"question\": \"8. How would you prioritize budget allocation across different aspects of the project?\",\"options\": [\"A. Construction\", \"B. Interior Finish\", \"C. Landscaping\", \"D. Equal allocation\"]},{\"question\": \"9. Home Space:\",\"options\": [\"A. 100 square meters\", \"B. 300+ square meters\", \"C. 500+ square meters\", \"D. 1000+ square meters\"]},{\"question\": \"10. How would you describe your desired atmosphere or ambiance for the interior and exterior spaces?\",\"options\": [\"A. Cozy\", \"B. Minimalist\", \"C. Elegant\", \"D. Modern\"]},{\"question\": \"11. Are there any specific design inspirations, such as a favorite vacation destination or art movement, that you'd like to draw upon for interior design?\",\"options\": [\"A. Color Picker\", \"B. Vintage\", \"C. Contemporary\", \"D. Natural\"]},{\"question\": \"12. Are you open to incorporating smart home technology for automation and control of various home systems?\",\"options\": [\"A. Security\", \"B. Lighting\", \"C. Entertainment\", \"D. All of the above\"]},{\"question\": \"13. Are there any weather-related concerns or considerations for your project, such as extreme temperatures or heavy rainfall during certain seasons?\",\"options\": [\"A. Extreme Temperature\", \"B. Heavy Raining\", \"C. Both\", \"D. None\"]},{\"question\": \"14. Have you thought about construction phasing if you need to occupy parts of the home before the entire project is completed?\",\"options\": [\"A. YES\", \"B. NO\", \"C. Not sure\", \"D. Partial occupancy planned\"]}]. Don't type anything else. Don't worry, I will guide you through the process. I will not ask all the questions at once. I will ask one question at a time. Please only respond in the given format only. If you are ready to begin, please type {\"status\": \"success\"}. If you are not ready to begin, please type  {\"status\": \"fail\"}. only in json format. use double quotes for keys and values."
}
...
business = {
  "initial": "\"Hello, we are assisting a client in determining if they can build a business building within budget and time constraints, using a set of questions and client answers, aligned with budget and feasibility checks, and presenting questions one by one.\", \"questions\": [{\"question\": \"1. What is the primary purpose or function of the business building?\", \"options\": [\"A. Office Space\", \"B. Retail Space\", \"C. Manufacturing\", \"D. Mixed-Use\"]}, {\"question\": \"2. What is the estimated total square footage required for the building?\", \"options\": [\"A. Under 10,000 sq ft\", \"B. 10,000 - 50,000 sq ft\", \"C. 50,000 - 100,000 sq ft\", \"D. Over 100,000 sq ft\"]}, {\"question\": \"3. Do you have any specific architectural style preferences for the building?\", \"options\": [\"A. Modern\", \"B. Traditional\", \"C. Contemporary\", \"D. Industrial\"]}, {\"question\": \"4. Are there any sustainability or environmental goals for the project?\", \"options\": [\"A. LEED Certification\", \"B. Energy Efficiency\", \"C. Green Roof\", \"D. None\"]}, {\"question\": \"5. How many floors or levels should the building have?\", \"options\": [\"A. Single-Story\", \"B. 2-3 Floors\", \"C. 4-6 Floors\", \"D. More than 6 Floors\"]}, {\"question\": \"6. Are there any zoning or regulatory constraints to consider?\", \"options\": [\"A. Yes\", \"B. No\", \"C. Not sure\", \"D. Local authorities' approval required\"]}, {\"question\": \"7. How many employees or occupants will the building house?\", \"options\": [\"A. Under 50\", \"B. 50-200\", \"C. 200-500\", \"D. Over 500\"]}, {\"question\": \"8. Are there any specialized spaces required, such as laboratories or conference rooms?\", \"options\": [\"A. Yes, specialized spaces\", \"B. Standard office spaces\", \"C. Mix of specialized and standard spaces\", \"D. Not sure\"]}, {\"question\": \"9. Do you have specific accessibility requirements, such as ramps or elevators?\", \"options\": [\"A. Yes, accessibility\", \"B. Basic accessibility features\", \"C. Limited accessibility requirements\", \"D. Not sure\"]}, {\"question\": \"10. Are there any desired amenities or common spaces, like a cafeteria or fitness center?\", \"options\": [\"A. Yes, extensive amenities\", \"B. Basic amenities\", \"C. Limited amenities\", \"D. Not sure\"]}, {\"question\": \"11. How many parking spaces do you anticipate needing for employees and visitors?\", \"options\": [\"A. No parking required\", \"B. Limited parking spaces\", \"C. Sufficient parking for employees and visitors\", \"D. Public transportation access\"]}, {\"question\": \"12. What atmosphere or ambiance do you desire for the interior and exterior spaces?\", \"options\": [\"A. Modern and Innovative\", \"B. Professional and Classic\", \"C. Contemporary and Open\", \"D. Other (please specify)\"]}, {\"question\": \"13. Are there any specific design inspirations or branding elements to incorporate into the interior design?\", \"options\": [\"A. Brand Colors and Logo\", \"B. Industry Themes\", \"C. Artistic Statements\", \"D. Neutral/None\"]}, {\"question\": \"14. Are you open to incorporating advanced technology for building automation, security, and energy efficiency?\", \"options\": [\"A. Smart Building Systems\", \"B. Security and Access Control\", \"C. Energy Management\", \"D. All of the above\"]}, {\"question\": \"15. Are there any weather-related concerns or site-specific challenges for your project?\", \"options\": [\"A. Extreme Weather\", \"B. Site Challenges\", \"C. Both\", \"D. None\"]}]}  Don't type anything else. Don't worry, I will guide you through the process. I will not ask all the questions at once. I will ask one question at a time. Please only respond in the given format only. If you are ready to begin, please type {\"status\": \"success\"}. If you are not ready to begin, please type  {\"status\": \"fail\"}. only in json format. use double quotes for keys and values."
  }
